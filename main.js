...
async function starts() {
	    ...
	    client.browserDescription = ["KABANERI","Ubuntu","18.04"]
	    client.logger.level = 'warn'
	    console.log(color(`]─`,`magenta`),`「`,  color(`KABANERI`,`red`), `」`,  color(`─[`,`magenta`))
	    client.on('qr', () => {
	    console.log(color('[','white'), color('!','red'), color(']','white'), color(' Scan Palcond Gak Scan Gak konek'))
	    })
        ...
        client.sendMessage(callerId, "Kamu telah di block + banned karena telpon kabane😒", MessageType.text)
